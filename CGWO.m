...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% chaotic gray wolf optimization (CGWO)                                         
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Grey Wolf Optimizer
function [Alpha_score,Alpha_pos,Convergence_curve,K,cxl]=CGWO(SearchAgents_no,Max_iter,lb,ub,dim,fobj)
% 初始化α,β,Delta_pos
...
%初始化的位置搜索
Positions=initialization0(SearchAgents_no,dim,ub,lb);
...
while l<Max_iter                  % 对迭代次数循环
    ...
    for i=1:size(Positions,1)
      ...
      for j=1:dim
          ...
          %cxl(j)=4*(7.86*cxl(j)-23.31*cxl(j)^2+28.75*cxl(j)^3-13.302875*cxl(j)^4);%Singer混沌方程
      end
    end
    l=l+1;    
